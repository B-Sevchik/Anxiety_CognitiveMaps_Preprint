...
#data paths to insert: lines 4, 13, 135
...
df <- read_csv('[INSERT DATA PATH TO original_data FILE FROM GITHUB]')
...
STAI_drag_drop_df_1 <- read_csv('[INSERT PATH TO data/STAI.csv FROM GITHUB]')
